...
from ooijh.drops import DROP_NUTNR_VARS, drop_qartod_test_vars


class NUTNR(KDATA):
    def __init__(self, site: str, node: str, instrument: str = 'NUTNR', stream: str = 'suna', 
        ...
        """
        A class for obtaining preprocessed and processed NUTNR data.
    ...
    def preprocess(self, ds_list: list) -> list:
        ...
        """
        ds_list = [ds.drop_vars(DROP_NUTNR_VARS, errors = 'ignore') for ds in ds_list]
