...
from ooijh.drops import DROP_PARAD_VARS, drop_qartod_test_vars


class PARAD(KDATA):
    def __init__(self, site: str, node: str, instrument: str = 'PARAD', stream: str = 'parad', 
        ...
        """
        A class for obtaining preprocessed and processed PARAD data.
    ...
    def preprocess(self, ds_list: list) -> list:
        ...
        """
        ds_list = [ds.drop_vars(DROP_PARAD_VARS, errors = 'ignore') for ds in ds_list]
