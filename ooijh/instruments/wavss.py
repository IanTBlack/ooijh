...
from ooijh.drops import DROP_WAVSS_VARS, drop_qartod_test_vars


class WAVSS(KDATA):
    def __init__(self, site: str, node: str, instrument: str = 'WAVSS', stream: str = 'mean', 
        ...
        """
        A class for obtaining preprocessed and processed WAVSS data.
    ...
    def preprocess(self, ds_list: list) -> list:
        ...
        """
        ds_list = [ds.drop_vars(DROP_WAVSS_VARS, errors = 'ignore') for ds in ds_list]
