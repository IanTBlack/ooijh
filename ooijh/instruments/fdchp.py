...
from ooijh.drops import DROP_FDCHP_VARS, drop_qartod_test_vars


class FDCHP(KDATA):
    def __init__(self, site: str, node: str, instrument: str = 'FDCHP', stream: str = 'fdchp', 
        ...
        """
        A class for obtaining preprocessed and processed FDCHP data.
    ...
    def preprocess(self, ds_list: list) -> list:
        ...
        """
        ds_list = [ds.drop_vars(DROP_FDCHP_VARS, errors = 'ignore') for ds in ds_list]
