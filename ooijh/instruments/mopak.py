...
from ooijh.drops import DROP_MOPAK_VARS, drop_qartod_test_vars


class MOPAK(KDATA):
    def __init__(self, site: str, node: str, instrument: str = 'MOPAK', stream: str = 'mopak', 
        ...
        """
        A class for obtaining preprocessed and processed MOPAK data.
    ...
    def preprocess(self, ds_list: list) -> list:
        ...
        """
        ds_list = [ds.drop_vars(DROP_MOPAK_VARS, errors = 'ignore') for ds in ds_list]
