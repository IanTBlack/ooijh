...
from ooijh.drops import DROP_DOSTA_VARS, drop_qartod_test_vars


class DOSTA(KDATA):
    def __init__(self, site: str, node: str, instrument: str = 'DOSTA', stream: str = 'dosta', 
        ...
        """
        A class for obtaining preprocessed and processed DOSTA data.
    ...
    def preprocess(self, ds_list: list) -> list:
        ...
        """
        ds_list = [ds.drop_vars(DROP_DOSTA_VARS, errors = 'ignore') for ds in ds_list]
